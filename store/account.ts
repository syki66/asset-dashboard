...
interface InterestRateState {
  bestInterestRates: { date: string; interestRate: number }[];
  worstInterestRates: { date: string; interestRate: number }[];
  setBestInterestRates: (
    rates: { date: string; interestRate: number }[],
  ) => void;
...
export const useInterestRateStore = create<InterestRateState>((set) => ({
  bestInterestRates: bestRateTable,
  worstInterestRates: worstRateTable,
  setBestInterestRates: (rates) => set({ bestInterestRates: rates }),
